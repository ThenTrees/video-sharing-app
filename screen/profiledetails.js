    ...
    const fetchData = async (id) => {
        try {
            ...
            if (response.data) {
                ...
                setData(followData);
                checkIsFollowing(my.id, user.id);
            }
        } catch (error) {
        ...
        <View style={[styles.container]}>
            ...
            <View style={styles.imgLogo}>
                <Image
                    ...
                    source={{
                        uri:
                            user.avatar ||
                            "https://www.adquickly.com/storage/app/default/user.png",
                    }}
                />
                <Text
                    style={{
            ...
            >
                <TouchableOpacity
                    ...
                    onPress={() => {
                        if (isFollowing) {
                            unfollow(my.id, user.id);
                        } else {
                            follow(my.id, user.id);
                        }
                    }}
                >
